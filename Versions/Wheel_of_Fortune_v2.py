...
##                print "counter is equal to:", counter
                ...
                if selection == 1:
                    ...
                    if (type(prize) is int) or (prize == "freePlay"):
                        ...
                        if type(prize) is "freePlay":
                            print playerOrder[j] + ", you may guess a free letter."
                            subPrize = 500
                        ...
                        if guess in hidden_word or prize == "freePlay":
                            ...
                            if letter_app == 0:
                                ...
                                print "Your Free Spin, however, means that you keep possession of The Wheel." 
                            if letter_app == 1:
                                print disp_word
                                ...
                                playerOrder_val_round[j][0] = playerOrder_val_round[j][0] + subPrize
                                print "Your total prize score is now $" + str(playerOrder_val_round[j][0]) + "!"
                            else:
                                print disp_word
                            ...
                            print "I'm sorry", playerOrder[j] + ", but there are no '" + guess.upper() + "'s in the puzzle."
                    if prize == "bankrupt":
                        print playerOrder[j], "spun for BANKRUPT! Bringing your prize for the round to $0."
...
##                                playerOrder_val_round[j][0] = playerOrder_val_round[j][0] + prize
##                                print "Your total prize score is now $" + str(playerOrder_val_round[j][0]) + "!"
##                            else:
##                                print disp_word
##                                print "Good guess:", playerOrder[j] + "! There are", letter_app, "'" + guess.upper() + "'s in the puzzle!"
##                                print "That adds $" + str(prize * letter_app) + " to your total prize score!"
##                                playerOrder_val_round[j][0] = playerOrder_val_round[j][0] + (prize * letter_app)
##                                print "Your total prize score is now $" + str(playerOrder_val_round[j][0]) + "!"
##                                raw_input("----------------------")
##                            possession = True
##                            if incom_word == hidden_word:
