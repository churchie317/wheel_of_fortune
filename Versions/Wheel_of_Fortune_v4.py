        ...
        while num_turns >= turn_num:
            ...
            if player_selection == 0:
                ...
                if guess == puzzle_and_clue[1]:
                    ...
                    print ""
                    print "Sorry, " + playerOrder[player_turn] + ". That is not the correct puzzle solution."
                ...
                if type(prize) is int:
                    ...
                    if guess in alpha:
                        ...
                        if guess in puzzle_and_clue[1]:
                            ...
                            time.sleep(1.5)
                            player_turn = (player_turn + 1) % 3
                            print "player_turn is now:", player_turn
                    else:
                        print ""
            ...
            if player_selection == 2:
                ...
                if guess in alpha:
                    ...
                    guess_previously_called(player_turn, playerOrder)
                    player_turn = (player_turn + 1) % 3
                    break
                print ""
                print string.center(("-" * 80), 80)
...
def guess_previously_called(player_turn, playerOrder):
    print ""
